...
class AccountValidationRequest
  ...
  def valid?
    ...
    country_validator = EnumAttributeValidator.new('String', ["BF", "BJ", "CG", "CI", "CM", "GA", "GH", "NG", "SN", "TD", "TG", "UG"])
  ...
  def country=(country)
    validator = EnumAttributeValidator.new('String', ["BF", "BJ", "CG", "CI", "CM", "GA", "GH", "NG", "SN", "TD", "TG", "UG"])
