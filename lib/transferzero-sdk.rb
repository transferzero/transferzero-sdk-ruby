...
require 'transferzero-sdk/models/bank_account_details'
require 'transferzero-sdk/models/bank_account_details_response'
...
require 'transferzero-sdk/models/entity'
require 'transferzero-sdk/models/entity_create_request'
require 'transferzero-sdk/models/entity_create_response'
require 'transferzero-sdk/models/entity_list_response'
require 'transferzero-sdk/models/entity_rating'
require 'transferzero-sdk/models/entity_state'
require 'transferzero-sdk/models/entity_update_request'
require 'transferzero-sdk/models/entity_update_response'
...
require 'transferzero-sdk/models/open_corporates_search'
require 'transferzero-sdk/models/open_corporates_search_request'
require 'transferzero-sdk/models/open_corporates_search_response'
require 'transferzero-sdk/models/open_corporates_sender_update'
require 'transferzero-sdk/models/open_corporates_sender_update_request'
require 'transferzero-sdk/models/open_corporates_sender_update_response'
require 'transferzero-sdk/models/open_corporates_sender_update_result'
require 'transferzero-sdk/models/open_corporates_supported_countries'
require 'transferzero-sdk/models/open_corporates_supported_countries_list_response'
...
require 'transferzero-sdk/models/politically_exposed_person_list_response'
require 'transferzero-sdk/models/politically_exposed_person_response'
...
require 'transferzero-sdk/models/sanctioned_country'
require 'transferzero-sdk/models/sanctioned_country_list_response'
...
require 'transferzero-sdk/models/transaction_req'
require 'transferzero-sdk/models/transaction_req_limits_response'
require 'transferzero-sdk/models/transaction_req_limits_response_object'
require 'transferzero-sdk/models/transaction_req_list_response'
require 'transferzero-sdk/models/transaction_req_request'
require 'transferzero-sdk/models/transaction_req_response'
...
require 'transferzero-sdk/api/bank_account_details_api'
require 'transferzero-sdk/api/currency_info_api'
require 'transferzero-sdk/api/documents_api'
require 'transferzero-sdk/api/entities_api'
require 'transferzero-sdk/api/logs_api'
require 'transferzero-sdk/api/open_corporates_company_search_api'
require 'transferzero-sdk/api/open_corporates_sender_update_api'
require 'transferzero-sdk/api/open_corporates_supported_countries_api'
...
require 'transferzero-sdk/api/politically_exposed_people_api'
require 'transferzero-sdk/api/recipients_api'
require 'transferzero-sdk/api/sanctioned_countries_api'
require 'transferzero-sdk/api/sender_documents_api'
require 'transferzero-sdk/api/senders_api'
require 'transferzero-sdk/api/transaction_requests_api'
